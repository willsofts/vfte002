...
<template>
  ...
  <div class="pt-page pt-page-current pt-page-controller search-pager">
    <PageHeader ref="pageHeader" :labels="labels" pid="vfte002" version="1.0.0" showLanguage="true" @language-changed="changeLanguage" :multiLanguages="multiLanguages" :build="buildVersion" />
...
export default {
  ...
  setup() {
    ...
    return { buildVersion, multiLanguages, labels, dataCategory, dataChunk, alreadyLoading, isShowModify };
  },
  mounted() {
