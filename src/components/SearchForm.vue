...
<div id="searchpanel" class="panel-body search-panel">
    <div class="row row-height">
        <div class="col-height col-md-3">
            <label>{{ labels.groupnames_label }}</label>
            <input type="text" v-model="localData.groupname" class="form-control input-md" maxlength="50" />
        </div>
...
<style>
  button.fa-data-modify { margin-right: 15px; }
</style>
<script>
import { ref } from 'vue';
import $ from "jquery";
...
const tableSettings = {
    ...
    columns: [
        {name: "groupname", type: "STRING", sorter: "groupname", label: "groupname_headerlabel" },
        ...
        {name: "seqno", type: "INTEGER", sorter: "seqno", label: "sequenceno_headerlabel", css: "text-center" },
    ],        
    actions: [
        {type: "button", action: "modify", css: "btn-edit fa-data-modify fa-btn fa fa-edit"},
